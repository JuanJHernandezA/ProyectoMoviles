            ...
            usuarios.forEachIndexed { index, usuario ->
                Row(
                    ...
                    Checkbox(
                        ...
                        onCheckedChange = { onSeleccionar(index) },
...
@Composable
fun VistaDePruebaUsuarios() {
    var usuarios = remember {
        mutableStateListOf(
    ...
    Box(
        ...
        Column(
            ...
            Button(onClick = { mostrarPopup = true }) {
            ...
            if (mostrarPopup) {
                VentanaSugerenciasUsuarios(
                    usuarios = usuarios,
                    onSeleccionar = { index ->
                        usuarios[index] = usuarios[index].copy(seleccionado = !usuarios[index].seleccionado)
                    },
...
@Composable
fun PreviewVentanaSugerenciasUsuarios() {
    val usuarios = listOf(
        UsuarioSugerido("Carlos Pérez", false),
        UsuarioSugerido("María Gómez", false),
        UsuarioSugerido("Luis Martínez", false)
